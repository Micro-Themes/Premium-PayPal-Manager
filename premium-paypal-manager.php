      ...
      $dot = ( PM_PAYPAL_DEBUG ) ? '.' : '.min.';
		...
		public function save_post_meta( $post_id ) {
			...
			if(isset($_POST['pm_paypal_payment_type'])){
				update_post_meta( $post_id, 'pm_paypal_payment_type', sanitize_text_field($_POST['pm_paypal_payment_type'] ));
			}
			
			//Donation options
			if(isset($_POST['pm_paypal_donation_amount'])){
				update_post_meta( $post_id, 'pm_paypal_donation_amount', sanitize_text_field($_POST['pm_paypal_donation_amount'] ));
			}

			if(isset($_POST['pm_paypal_donation_placeholder'])){
				update_post_meta( $post_id, 'pm_paypal_donation_placeholder', sanitize_text_field($_POST['pm_paypal_donation_placeholder'] ));
			}
						
			//Payment options
			if(isset($_POST['pm_paypal_payment_option1'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option1', sanitize_text_field($_POST['pm_paypal_payment_option1'] ));
			}
			if(isset($_POST['pm_paypal_payment_option1_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option1_price', sanitize_text_field($_POST['pm_paypal_payment_option1_price'] ));
			}
			if(isset($_POST['pm_paypal_payment_option2'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option2', sanitize_text_field($_POST['pm_paypal_payment_option2'] ));
			}
			if(isset($_POST['pm_paypal_payment_option2_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option2_price', sanitize_text_field($_POST['pm_paypal_payment_option2_price'] ));
			}
			if(isset($_POST['pm_paypal_payment_option3'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option3', sanitize_text_field($_POST['pm_paypal_payment_option3'] ));
			}
			if(isset($_POST['pm_paypal_payment_option3_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option3_price', sanitize_text_field($_POST['pm_paypal_payment_option3_price'] ));
			}
			if(isset($_POST['pm_paypal_payment_option4'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option4', sanitize_text_field($_POST['pm_paypal_payment_option4'] ));
			}
			if(isset($_POST['pm_paypal_payment_option4_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option4_price', sanitize_text_field($_POST['pm_paypal_payment_option4_price'] ));
			}
			if(isset($_POST['pm_paypal_payment_option5'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option5', sanitize_text_field($_POST['pm_paypal_payment_option5'] ));
			}
			if(isset($_POST['pm_paypal_payment_option5_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option5_price', sanitize_text_field($_POST['pm_paypal_payment_option5_price'] ));
			}
			if(isset($_POST['pm_paypal_payment_option6'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option6', sanitize_text_field($_POST['pm_paypal_payment_option6'] ));
			}
			if(isset($_POST['pm_paypal_payment_option6_price'])){
				update_post_meta( $post_id, 'pm_paypal_payment_option6_price', sanitize_text_field($_POST['pm_paypal_payment_option6_price'] ));
			}		
			if(isset($_POST['pm_paypal_monthly_payment_option'])){
				update_post_meta( $post_id, 'pm_paypal_monthly_payment_option', sanitize_text_field($_POST['pm_paypal_monthly_payment_option'] ));
			}
			if(isset($_POST['pm_paypal_display_recurring_options'])){
				update_post_meta( $post_id, 'pm_paypal_display_recurring_options', sanitize_text_field($_POST['pm_paypal_display_recurring_options'] ));
			}
			if(isset($_POST['pm_paypal_default_recurring_option'])){
				update_post_meta( $post_id, 'pm_paypal_default_recurring_option', sanitize_text_field($_POST['pm_paypal_default_recurring_option'] ));
			}			
			
			if(isset($_POST['pm_paypal_monthly_payment_text'])){
				update_post_meta( $post_id, 'pm_paypal_monthly_payment_text', sanitize_text_field($_POST['pm_paypal_monthly_payment_text'] ));
			}
			if(isset($_POST['pm_paypal_monthly_payment_price'])){
				update_post_meta( $post_id, 'pm_paypal_monthly_payment_price', sanitize_text_field($_POST['pm_paypal_monthly_payment_price'] ));
			}
			
			//Product options
			if(isset($_POST['pm_paypal_product_display_availablity'])){
				update_post_meta( $post_id, 'pm_paypal_product_display_availablity', sanitize_text_field($_POST['pm_paypal_product_display_availablity'] ));
			}
			if(isset($_POST['pm_paypal_product_availablity'])){
				update_post_meta( $post_id, 'pm_paypal_product_availablity', sanitize_text_field($_POST['pm_paypal_product_availablity'] ));
			}
			if(isset($_POST['pm_paypal_product_code'])){
				update_post_meta( $post_id, 'pm_paypal_product_code', sanitize_text_field($_POST['pm_paypal_product_code']) );
			} 
